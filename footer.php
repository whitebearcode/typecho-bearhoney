        ...
        <div class="row">
            <div class="col-md-12">
                <div class="footer-widget row d-flex align-items-center justify-content-between flex-wrap">
                            <div class="bcopyright fleft">
                        &copy; <?php echo date("Y");?> <a href="<?php $this->options->siteUrl();?>"><?php $this->options->title();?></a> All right Reserved.  <br>
                        <?php _e('Powered by <a href="http://www.typecho.org">Typecho</a> & <a href="https://github.com/whitebearcode/typecho-bearhoney"> BearHoney</a> '); ?>
             
                 </div>
                 <div class="bcopyright fright">
                     
     <?php if (General::Options('IcpBa')): ?><img width=20 height=20  src="<?php $this->options->themeUrl('assets/images/icpba.svg');?>"> <a href="https://beian.miit.gov.cn/"><?php echo General::Options('IcpBa'); ?></a><?php endif; ?><br><?php if (General::Options('PoliceBa')): ?><img width=20 height=20 src="<?php $this->options->themeUrl('assets/images/policeba.svg');?>"> <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=<?php echo General::parseNumber(General::Options('PoliceBa')); ?>"><?php echo General::Options('PoliceBa'); ?></a><?php endif; ?>
...
<script src="//cdn.staticfile.org/fancyapps-ui/5.0.24/fancybox/fancybox.umd.min.js"></script>
