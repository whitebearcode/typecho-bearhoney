...
<footer class="honey_footer">
    ...
    <svg class="honey_waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
			...
			<g class="honey_parallax">
				...
				<use xlink:href="#honey-wave" x="48" y="1" fill="rgba(255,255,255,0.6" />
				<use xlink:href="#honey-wave" x="48" y="3" fill="rgba(255,255,255,0.5)" />
				<use xlink:href="#honey-wave" x="48" y="5" fill="rgba(255,255,255,0.3)" />
				<use xlink:href="#honey-wave" x="48" y="7" fill="#1a1a1a" />
			</g>
		</svg>
		<?php endif; ?>
