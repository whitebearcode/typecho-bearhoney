...
<footer class="honey_footer">
    ...
    <svg class="honey_waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
			...
			<g class="honey_parallax">
				...
				<use xlink:href="#honey-wave" x="48" y="6" fill="#1a1a1a" />
			</g>
		</svg>
		<?php endif; ?>
...
<div class="container">
    <div class="row g-2 g-lg-4 align-items-center">
     ...
     <?php if (General::Options('IcpBa') && General::Options('PoliceBa')): ?>  | <?php endif; ?><?php if (General::Options('IcpBa')): ?><img width=20 height=20 style="margin-top:4px" src="<?php $this->options->themeUrl('assets/images/icpba.svg');?>"> <a href="https://beian.miit.gov.cn/"><?php echo General::Options('IcpBa'); ?></a><?php endif; ?><br><?php if (General::Options('PoliceBa')): ?><img width=20 height=20 style="margin-top:3px" src="<?php $this->options->themeUrl('assets/images/policeba.svg');?>"> <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=<?php echo General::parseNumber(General::Options('PoliceBa')); ?>"><?php echo General::Options('PoliceBa'); ?></a><?php endif; ?>
        </div> 
