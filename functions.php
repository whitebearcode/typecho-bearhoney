  ...
  CSF::createSection( $prefix, array(
    ...
    'fields' => array(
      ...
      array(
        ...
        'after' => '请填入站点文字LOGO<br><font color=red>v1.0.8版本暂不支持添加图片LOGO，请等待后续更新~</font>',
      ),
      ...
      array(
            ...
            'type'    => 'text',
            'title'   => 'Twikoo服务URL',
            'after' => '当前v1.0.8版本暂未添加原生评论功能，请等待后续版本更新，暂时仅支持Twikoo服务<br>若有需要，请填写Twikoo服务URL以启用评论（在文章不关闭评论功能的情况下）',
        ),
    )
  ) );
CSF::createSection( $prefix, array(
...
<script src="'.Helper::options()->themeUrl.'/assets/js/bearhoney_backend.js?v=7"></script>
',
                ),
