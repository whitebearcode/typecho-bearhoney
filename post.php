          ...
          <ul class="card-meta list-inline mb-2">
            <li class="list-inline-item mt-2">
              <a href="<?php $this->author->permalink() ?>" class="card-meta-author" title="<?php $this->author(); ?>的文章">
                <img class="w-auto" src="<?php echo General::getAvatar($this->author->mail); ?>" alt="Thomas Macaulay" width="26" height="26">  <span><?php $this->author->screenName(); ?></span>
              </a>
            </li>
...
<div class="single-post-similer post-content-block order-0 order-lg-2">
...
<div class="row gy-5 gx-4 g-xl-5 justify-content-center">
              ...
              <div class="col-lg-6">
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevrons-left" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ef8677" fill="none" stroke-linecap="round" stroke-linejoin="round">
  ...
  <path d="M17 7l-5 5l5 5" />
		...
		<div class="col-lg-6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevrons-right" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ef8677" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  <path d="M13 7l5 5l-5 5" />
    ...
    <?php echo General::getRandomPosts();?>
