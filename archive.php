          ...
          <div class="card-body">
           <a class="d-block" href="<?php $this->permalink() ?>"
              ...
              <div class="post-image position-relative">
                <img class="w-100 h-auto rounded" src="<?php echo General::firstThumb($this);?>" alt="<?php $this->title() ?>" style="max-height:300px;object-fit: cover"  loading="lazy">
              </div>
            </a>
            ...
            <p><?php if($this->fields->excerpt):?><?php echo $this->fields->excerpt;?><?php else:?><?php echo General::cutexpert($this->excerpt,20);?></p>
          </div>
          <div class="card-footer border-top-0 bg-transparent p-0">
            <ul class="card-meta list-inline">
              <li class="list-inline-item mt-2">
                <a href="<?php $this->author->permalink();?>" class="card-meta-author" title="<?php echo $this->author->name;?>">
                  <img class="w-auto" src="<?php echo General::getAvatar($this->author->mail); ?>" alt="Thomas Macaulay" width="26" height="26"> <span><?php echo $this->author->screenName;?></span>
                </a>
              </li>
