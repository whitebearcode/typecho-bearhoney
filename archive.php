          ...
          <div class="card-body">
           <a class="d-block" href="<?php $this->permalink() ?>"
              ...
              <div class="post-image position-relative">
                <img class="rounded img-fluid" src="<?php echo General::firstThumb($this);?>" alt="<?php $this->title() ?>"  style="max-height:300px;object-fit: cover" loading="lazy" decoding="async">
              </div>
            </a>
