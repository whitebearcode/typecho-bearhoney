...
const FRAMEWORK_PLUGIN_NAME = 'plugin:BearHoneyCore_';
const FRAMEWORK_KEY_PARMAS_NAME = 'plugin:bhOF_key_params';
...
if (!function_exists('update_bh_key_params')) {
    function update_bh_key_params($option, $value, $autoload = null)
    {
        $db = Db::get();
...
if (!function_exists('get_bh_key_params')) {

// get option for framework
    function get_bh_key_params($option, $default = false)
    {
        $db = Db::get();
        $pluginName = FRAMEWORK_KEY_PARMAS_NAME;
        $select = $db->select()->from('table.options')
