...
<html lang="zh-cn" data-theme="light">
 ...
 <?php endif; ?>
  ...
  <link rel="stylesheet" href="<?php $this->options->themeUrl('assets/css/bearhoney.min.css?v='); ?><?php echo themeVersion();?>">
		 <link rel="stylesheet" type="text/css" href="<?php $this->options->themeUrl('assets/css/bearhoneycards.min.css?v='); ?><?php echo themeVersion();?>">
  ...
  <link href="//cdn.staticfile.org/remixicon/3.5.0/remixicon.min.css" rel="stylesheet">
  <link href="https://cdn.staticfile.org/fancyapps-ui/5.0.24/fancybox/fancybox.min.css" rel="stylesheet">
